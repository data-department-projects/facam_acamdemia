/**
 * Page Compte — Informations du profil étudiant.
 * Affiche nom, email, rôle, date de première connexion et formulaire de changement de mot de passe.
 * Données lues depuis localStorage (facam_user).
 */
              ...
              <div className="border-t border-gray-100 pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-facam-dark font-medium capitalize">
